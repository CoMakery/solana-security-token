...
pub fn initialize_security_associated_account(
    ...
    security_associated_account.holder = ctx.accounts.holder.id;
    security_associated_account.transfer_restriction_data = ctx.accounts.transfer_restriction_data.key();
