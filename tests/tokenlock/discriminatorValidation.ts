...
import { assert } from "chai"; import { Keypair } from "@solana/web3.js";
...
describe('TokenLockup fund release schedues', () => {
    ...
    it('initialize timelock with wrong tokenlock account', async () => {
        ...
        const timelockAccountPubkey = getTimelockAccount(tokenlockProgram.programId, timelockPK1, recipient2.publicKey);
    ...
    it('create release schedule with wrong tokenlock account', async () => {
        ...
        const timelockAccount = getTimelockAccount(tokenlockProgram.programId, timelockPK1, recipient2.publicKey);
    ...
    it('fund release schedule with wrong tokenlock account', async () => {
        ...
        const timelockAccount1 = getTimelockAccount(tokenlockProgram.programId, tokenlockDataPubkey, walletA.publicKey);
        let accInfo = await tokenlockProgram.provider.connection.getAccountInfo(timelockAccount1);
            ...
            await tokenlockProgram.rpc.mintReleaseSchedule(
                ...
                [],
                {
                    accounts: {
                        ...
                        accessControlProgram: testEnvironment.accessControlHelper.program.programId,
                    },
                    signers: [reserveAdmin],
                },
            );
